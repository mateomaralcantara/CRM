...
class CRMAPITester:
    def __init__(self, base_url="https://member-admin-1.preview.emergentagent.com"):
        ...
        self.test_user_password = "TestPassword123!"  # Stronger password
    ...
    def test_permission_system_user_role(self):
        ...
        user_email = f"user{timestamp}@gmail.com"
        user_data = {
            "name": "Regular User",
            "email": user_email,
    ...
    def run_all_tests(self):
        ...
        basic_tests = [
            ...
            self.test_authentication_system_analysis,
            self.test_api_endpoints_structure,
            self.test_critical_functionality_without_auth,
        ]
